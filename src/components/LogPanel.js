...
function LogPanel({activateDecomAll}) {
  ...
  return (
    <Segment className="HQComps" id="logPanel">
      ...
      {allActive ? 
        <Button fluid color={"green"} content={"DECOMMISSION ALL"} onClick={toggleActivation} />:
        <Button fluid color={"red"} content={"ACTIVATE ALL"} onClick={toggleActivation}/> }
    </Segment>
  );
}
